 ...
 *
 * Players are instantiated with the {@link create} function.
 * The player communicates events asynchronously via {@link Player.addEventListener}.
 */
declare interface Player {
     ...
     * When native video controls are enabled and the player is rendering via MediaSourceExtensions, the duration is
     * 2^30 (1073741824). Otherwise, the duration is Infinity.
     */
    getDuration(): number;
